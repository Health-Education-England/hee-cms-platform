 ...
 */
public class TaxonomySingleBrowser extends TaxonomyBrowser {
    ...
    public TaxonomySingleBrowser(String id, IModel<Classification> model, TaxonomyModel taxonomyModel, Locale preferredLocale) {
        super(id, model, taxonomyModel, preferredLocale);
    }

    public TaxonomySingleBrowser(String id, IModel<Classification> model, TaxonomyModel taxonomyModel, Locale preferredLocale, boolean detailsReadOnly, ITreeNodeIconProvider iconProvider, boolean multiple) {
        ...
        public ParameterisedDetails(String id, CategoryModel model) {
            ...
            this.addOrReplace(new AjaxLink<Category>(ADD, model) {
                ...
                public void onClick(AjaxRequestTarget target) {
                    ...
                    TaxonomySingleBrowser.this.modelChanged();
            ...
            addOrReplace(new AjaxLink<Category>(ADD_ANCESTORS, model) {
                ...
                public boolean isVisible() {
                    String key = getModelObject().getKey();
                    if ((!TaxonomySingleBrowser.this.getMultiple() && getKeys().size() > 0)
