 ...
 * for the Image link (compound type) ({@code hippogallerypicker:imagelink}) when used as a content block.</p>
 *
 * <p>validates if the editor has selected/chosen an image
 * for the Image link (compound type) ({@code hippogallerypicker:imagelink}) content block.</p>
 */
