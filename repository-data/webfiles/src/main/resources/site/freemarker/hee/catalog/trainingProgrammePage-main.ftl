    ...
    <main class="page page--rightbar" id="maincontent" role="main" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="page__layout nhsuk-width-container">
            ...
            <aside class="page__rightbar">
                ...
                <#--  Table of content  -->
                <div class="hee-card hee-card--programme theme__item-border">
                    <div class="hee-card--programme__content">
                        <h3 class="hee-card--programme__heading">Pages related to this programme</h3>
                        <ul class="hee-card--programme__list">
                            <#assign accessWithEndSlash=hstRequestContext.servletRequest.requestURI?ends_with("/")/>
                            <#--  Overview link  -->
                            <#if isOverview>
                                <li aria-current="page">
                                    <span aria-current="page" class="hee-card--programme__link active">Overview</span>
                                </li>
                            <#else>
                                <li>
                                    <a class="hee-card--programme__link" href="${(accessFromRootHub && !accessWithEndSlash)?then(tppSiteMapItemName + '/overview', 'overview')}">Overview</a>
                                </li>
                            </#if>
                            ...
                            <#list document.applicationInformation as guidance>
                                <#if currentGuidance?? && guidance == currentGuidance>
                                    <li aria-current="page">
                                        <span aria-current="page" class="hee-card--programme__link active">${guidance.title}</span>
                                    </li>
                                <#else>
                                    <li>
                                        <a class="hee-card--programme__link" href="${(accessFromRootHub && !accessWithEndSlash)?then(tppSiteMapItemName + '/' + guidance.name, guidance.name)}">${guidance.title}</a>
                                    </li>
                                </#if>
                            </#list>
                        </ul>
