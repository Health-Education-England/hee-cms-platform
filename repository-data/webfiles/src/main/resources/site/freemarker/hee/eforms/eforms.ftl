...
-->
    ...
    <@hst.headContribution keyHint="jqueryDatetimePickerCss">
        <link rel="stylesheet" href="<@hst.link path="static/css/jquery.datetimepicker-2.3.7.min.css"/>"
              type="text/css"/>
    </@hst.headContribution>
    ...
    <@hst.headContribution keyHint="jquery-datetimepicker">
        <script type="text/javascript"
                src="<@hst.link path="static/js/jquery.datetimepicker.full-2.3.7.min.js"/>"></script>
    </@hst.headContribution>
