...
<div class="nhsuk-width-container nhsuk-header__container">
    <div class="nhsuk-header__logo">
        <@hst.link var="homeURL" siteMapItemRefId="root"/>
        <a class="nhsuk-header__link" href="${homeURL}" aria-label="NHS homepage">
            ...
            <span class="nhsuk-organisation-descriptor">${organizationName}</span>
        </a>
    </div>
