...
<div class="nhsuk-width-container nhsuk-header__container">
    ...
    <div class="nhsuk-header__multilogo">
        ...
        <span class="nhsuk-header__logo nhsuk-header__logo-home">
            <#-- NHS/HEE logo: START  -->
            <#-- CAN THE HREF BE CONTROLLED BY THE CMS? (NHS/HEE URL) -->
            <a class="nhsuk-header__link" href="https://hee.nhs.uk/" aria-label="HEE Home">
            ...
            <#--  Channel org name & descriptor: START  -->
            ...
            <a class="nhsuk-header__link" href="<@hst.link siteMapItemRefId='root'/>" aria-label="${hstRequestContext.resolvedMount.mount.channelInfo.organisationName}">
            ...
            <#--  Channel org name & descriptor: END  -->
        </span>
