...
<#macro report reportDocument showTitle=true showCookiesButton=false>
<#-- @ftlvariable name="reportDocument" type="uk.nhs.hee.web.beans.Report" -->
    <#if reportDocument??>
        <div class="nhsuk-width-container">
            ...
            <article>
                <div class="nhsuk-grid-row">
                    <div class="nhsuk-grid-column-two-thirds">
                        <section class="nhsuk-page-content__section-one">
                            <div class="nhsuk-page-content">
                                <#if reportDocument.summary??>
                                    <p class="nhsuk-body-l"><@hst.html formattedText="${reportDocument.summary!?replace('\n', '<br>')}"/></p>
                                </#if>
                                <#if reportDocument.contentBlocks??>
                                    <#list reportDocument.contentBlocks as block>
                                ...
                                <@hee.lastNextReviewedDate lastNextReviewedDate=reportDocument.pageLastNextReview/>
                            </div>
                        </section>
                    </div>

                    <#if reportDocument.rightHandBlocks??>
                        <div class="nhsuk-grid-column-one-third">
                            <#list reportDocument.rightHandBlocks as block>
                                <#switch block.getClass().getName()>
                    ...
                    <#if reportDocument.relatedContent??>
                        <div class="nhsuk-grid-column-full nhsuk-section__content">
                            <@hee.contentCards contentCards=reportDocument.relatedContent/>
                        </div>
                    </#if>
                </div>
            </article>
