...
@HippoEssentialsGenerated(internalName = "hee:publicationCollectionPage")
@Node(jcrType = "hee:publicationCollectionPage")
public class PublicationCollectionPage extends BaseDocument {
