...
@HippoEssentialsGenerated(internalName = "hee:publicationListingPage")
@Node(jcrType = "hee:publicationListingPage")
public class PublicationListingPage extends ListingPage {
    @Override
